...
import 'package:first_app/pager_indicator.dart';
...
class _PageDraggerState extends State<PageDragger> {
  ...
  onDragUpdate(DragUpdateDetails details) {
    ...
    //  slidePercent = (dx / FULL_TRANSITION_PX).clamp(0.0 , 1.0);
...
class AnimatedPageDragger {
  ...
  AnimatedPageDragger({
    ...
    if(transitionGoal == TransitionGoal.open) {
      ...
      endSlidePercent = 0.0;
      duration = new Duration(
        milliseconds: (slideDirection / PERCENT_PER_MILLISECOND).round()
      );
    }
